...
public class Quick {
    ...
    private static int partition(MyString[] a, int lo, int hi) {
        int i = lo;
        int j = hi + 1;
        MyString v = a[lo];
        while (true) {
     ...
     */
    public static MyString select(MyString[] a, int k) {
        if (k < 0 || k >= a.length) {
    ...
    ***************************************************************************/
    private static boolean isSorted(MyString[] a) {
        return isSorted(a, 0, a.length - 1);
    }

    private static boolean isSorted(MyString[] a, int lo, int hi) {
