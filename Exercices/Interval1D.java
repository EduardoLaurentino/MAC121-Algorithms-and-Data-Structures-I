...
public class Interval1D {
    ...
    private static class DistBoltComparator implements Comparator<Nut> {
        public int compare(Nut a, Nut b, Bolt c) {
            int distA = a.compareTo(c);
            int distB = b.compareTo(c);
    ...
    private static class DistNutComparator implements Comparator<Bolt> {
        public int compare(Bolt a, Bolt b, Nut c) {
            int distA = a.compareTo(c);
            int distB = b.compareTo(c);
            if      (distA < distB) return -1;
            else if (distA > distB) return +1;
